...
def step_variable_equal_to_value(context: Context, name: str, expected_value: str):
    ...
    :param expected_value: the expected value, interpreted using :py:func:`literal_eval`
    """
...
def step_get_element(context: Context, name: str, key: str, new_name: str):
    ...
    :param key: the key of the element to access, will be interpreted using :py:func:`literal_eval`
