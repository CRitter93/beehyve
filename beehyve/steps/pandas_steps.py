...
@given("series {name:w} <-")
def step_load_table_into_series(context: Context, name: str) -> None:
...
def step_load_csv_into_df_with_kwargs(
    context: Context, file_name: str, name: str, kwargs: Dict[str, str] = None
) -> None:
...
def step_df_equal_to_table_w_kwargs(context: Context, name: str, kwargs: Mapping[str, Any] = None) -> None:
...
def step_df_equal_to_df_w_kwargs(context: Context, name1: str, name2: str, kwargs: Mapping[str, Any] = None) -> None:
...
def step_series_equal_to_table_w_kwargs(context: Context, name: str, kwargs: Mapping[str, Any] = None) -> None:
...
def step_series_equal_to_series_w_kwargs(
    context: Context, name1: str, name2: str, kwargs: Mapping[str, Any] = None
) -> None:
